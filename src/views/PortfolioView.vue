    ...
    <div class="max-w-5xl mx-auto px-6 space-y-16">
      ...
      <div class="text-center max-w-2xl mx-auto space-y-4">
        ...
        <p class="text-theme-text-muted text-base sm:text-lg leading-relaxed">
          Studi kasus proyek nyata yang telah beroperasi di lingkungan live production dengan performa tinggi.
        </p>
      </div>

      <!-- Projects List in Unified Cards -->
      <div class="space-y-12">
        
        <!-- Project 1: Lentera Indramayu -->
        <div class="card-unified portfolio-item p-8 sm:p-10 space-y-8">
          <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-3 border-b border-theme-border pb-4">
            <div class="flex items-center gap-2.5">
              <span class="w-2.5 h-2.5 rounded-full bg-[#27C93F] animate-pulse"></span>
              <span class="text-xs font-mono font-bold uppercase tracking-wider text-cyan">
                PLATFORM PEMERINTAHAN & PWA
              </span>
            </div>
            <span class="text-xs font-mono text-theme-text-faint">LIVE PRODUCTION</span>
          </div>

          <!-- Visual Browser Window Mockup -->
          <div class="rounded-lg overflow-hidden border border-white/15 shadow-md bg-[#0A2647] text-white">
            <!-- Browser Top Bar -->
          ...
          <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
            <div class="lg:col-span-8 space-y-4">
              <h2 class="text-2xl sm:text-3xl font-display font-light text-white">
                LENTERA — Pemerintah Kabupaten Indramayu
              </h2>
              <p class="text-theme-text-muted text-base leading-relaxed">
                Platform digital sentral Pemkab Indramayu yang memadukan layanan publik terpadu, keterbukaan informasi, dan sektor ekonomi kerakyatan ke dalam satu arsitektur Progressive Web App (PWA) yang cepat diakses dari ponsel warga.
              </p>

              <div class="space-y-2 pt-2 text-sm text-white font-medium">
            ...
            <div class="lg:col-span-4 bg-theme-base/60 p-6 rounded-lg border border-theme-border space-y-4">
              <div class="space-y-2 text-xs font-mono">
                <div class="text-theme-text-faint">KLIEN:</div>
                <div class="font-bold text-white text-sm">Pemkab Indramayu</div>
                <div class="text-theme-text-faint pt-2">TEKNOLOGI:</div>
                <div class="font-medium text-white">Laravel, PWA, REST API</div>
              </div>
              ...
              <div class="pt-2">
                <a 
                  ...
                  class="btn-pill-primary w-full text-center text-xs uppercase font-bold py-3"
                >
                  Buka Website
                </a>
              </div>
        ...
        <div class="card-unified portfolio-item p-8 sm:p-10 space-y-8">
          ...
          <!-- Visual Browser Window Mockup -->
          <div class="rounded-lg overflow-hidden border border-white/15 shadow-md bg-[#064E3B] text-white">
            <!-- Browser Top Bar -->
          ...
          <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
            <div class="lg:col-span-8 space-y-4">
              ...
              <p class="text-theme-text-muted text-base leading-relaxed">
                Website promosi potensi lokal Desa Gumiwang. Menampilkan kekayaan agrikultur, perikanan, keindahan alam, serta etalase digital produk UMKM lokal dengan kecepatan pemuatan instan.
              </p>
            ...
            <div class="lg:col-span-4 bg-theme-base/60 p-6 rounded-lg border border-theme-border space-y-4">
              <div class="space-y-2 text-xs font-mono">
                <div class="text-theme-text-faint">KLIEN:</div>
                <div class="font-bold text-white text-sm">Desa Gumiwang</div>
                <div class="text-theme-text-faint pt-2">TEKNOLOGI:</div>
                <div class="font-medium text-white">Vite, TailwindCSS, Responsive</div>
              </div>
        ...
        <div class="card-unified portfolio-item p-8 sm:p-10 space-y-8">
          <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-3 border-b border-theme-border pb-4">
            <div class="flex items-center gap-2.5">
              <span class="w-2.5 h-2.5 rounded-full bg-[#27C93F]"></span>
              <span class="text-xs font-mono font-bold uppercase tracking-wider text-magenta">
                APLIKASI FINANSIAL DIGITAL
              </span>
            </div>
            <span class="text-xs font-mono text-theme-text-faint">LIVE PRODUCTION</span>
          </div>
          ...
          <!-- Visual Browser Window Mockup -->
          <div class="rounded-lg overflow-hidden border border-white/15 shadow-md bg-[#312E81] text-white">
            <!-- Browser Top Bar -->
          ...
          <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
            <div class="lg:col-span-8 space-y-4">
              ...
              <p class="text-theme-text-muted text-base leading-relaxed">
                Aplikasi web pembukuan kas harian bagi pelaku usaha mikro. Membantu pencatatan kas masuk/keluar secara instan, kalkulasi saldo otomatis, dan pembuatan laporan keuangan tanpa rumus spreadsheet manual.
              </p>
            ...
            <div class="lg:col-span-4 bg-theme-base/60 p-6 rounded-lg border border-theme-border space-y-4">
              <div class="space-y-2 text-xs font-mono">
                <div class="text-theme-text-faint">KATEGORI:</div>
                <div class="font-bold text-white text-sm">Productivity Web App</div>
                <div class="text-theme-text-faint pt-2">TEKNOLOGI:</div>
                <div class="font-medium text-white">Single Page App, TailwindCSS</div>
              </div>
              ...
              <div class="pt-2">
                <a 
                  ...
                  target="_blank" 
                  rel="noopener noreferrer"
                  class="btn-pill-action w-full text-center text-xs uppercase font-bold py-3"
                >
                  Buka Web App
                </a>
              </div>
      ...
      <!-- Action Box -->
      <div class="card-unified p-8 sm:p-10 text-center space-y-4 bg-theme-elevated">
        <h3 class="text-2xl font-display font-light text-white">Ingin Mewujudkan Solusi Serupa?</h3>
        <p class="text-theme-text-muted text-sm max-w-md mx-auto leading-relaxed">Diskusikan kebutuhan proyek Anda bersama tim Nexa untuk mendapatkan solusi teknis terbaik.</p>
        <div class="pt-3">
          <router-link to="/kontak" class="btn-pill-primary text-xs uppercase font-bold py-3.5 px-8">
...
onMounted(() => {
  animateStaggerFadeIn('.portfolio-item', { delay: 150, stagger: 150 })
})
</script>
